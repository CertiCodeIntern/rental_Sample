...
function initNotifications() {
    // Components are initialized in the HTML inline script with proper container IDs
    ...
    notifications.forEach(notification => {
        ...
        switch(filter) {
            ...
            case 'returns':
                ...
                break;
            case 'promos':
                shouldShow = notification.dataset.type === 'promo';
                break;
            default:
                shouldShow = true;
        }
...
function updateFilterCounts() {
    ...
    const promosCount = document.querySelectorAll('.notification-item[data-type="promo"]').length;
    ...
    updateCountBadge('promos', promosCount);
}
