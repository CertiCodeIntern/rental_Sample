...
<head>
    ...
    <meta name="description" content="RentIt - Videoke Rental Management System. Login or create an account to manage your rentals.">
...
<body>
                ...
                <div class="form-wrapper fade-in" id="formWrapper">
                    ...
                    <form id="loginForm">
                        ...
                        <div class="auth-social stagger-child">
                            <button type="button" class="auth-social-btn facebook-btn">
    ...
    <script src="client/auth/js/auth.js"></script>
</body>
</html>
