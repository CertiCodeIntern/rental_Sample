...
<body>
                    ...
                    <div class="kpi-row">
                        <article class="kpi-card">
                            ...
                            <div class="kpi-content">
                                ...
                                <div class="kpi-value" id="lifetimeRentals">24</div>
                            </div>
                        </article>
                ...
                <section class="history-section">
                    <div class="history-panel">
                        <table class="history-table" role="table" aria-label="Booking history">
                            ...
                            <tbody id="historyTableBody">
                                ...
                                <tr>
                                    <td>
                                        <div class="item-cell">
                                            <div class="item-img" aria-hidden="true">K</div>
                                            <div class="item-info">
                                                <div class="item-name">Karaoke Pro System X-100</div>
                                                <div class="small-muted">Portable karaoke machine • 2 mic</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="small-muted">#VDK-8921-01</td>
                                    <td>
                                        <div class="period">
                                            <div class="date-start">Oct 12, 2023</div>
                                            <div class="date-end">to Oct 15, 2023</div>
                                        </div>
                                    </td>
                                    <td class="amount-cell"><strong>₱125.00</strong></td>
                                    ...
                                    <td>
                                        <div class="actions-cell">
                                            ...
                                            <button class="action-btn action-review" aria-label="Rate & Review" title="Rate & Review" data-product-id="1" data-product-name="Karaoke Pro System X-100">
                                                <svg width="14" height="14" viewBox="0 0 24 24" aria-hidden="true">
                                ...
                                <tr>
                                    <td>
                                        <div class="item-cell">
                                            <div class="item-img" aria-hidden="true">P</div>
                                            <div class="item-info">
                                                <div class="item-name">Party Box Master V2</div>
                                                <div class="small-muted">Compact party speaker • bluetooth</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="small-muted">#VDK-7742-05</td>
                                    <td>
                                        <div class="period">
                                            <div class="date-start">Sep 20, 2023</div>
                                            <div class="date-end">to Sep 21, 2023</div>
                                        </div>
                                    </td>
                                    <td class="amount-cell"><strong>₱45.00</strong></td>
                                    <td><span class="status-pill status-completed">Completed</span></td>
                                    <td>
                                        <div class="actions-cell">
                                            <a class="action-btn action-download" href="#" download aria-label="Download receipt" title="Download receipt">
                                            ...
                                            <button class="action-btn action-review" aria-label="Rate & Review" title="Rate & Review" data-product-id="2" data-product-name="Party Box Master V2">
                                                <svg width="14" height="14" viewBox="0 0 24 24" aria-hidden="true">
                                                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
                                                </svg>
                                            </button>
                                ...
                                <!-- Row 3 - Cancelled (NO review button) -->
                                <tr>
                                    <td>
                                        <div class="item-cell">
                                            <div class="item-img" aria-hidden="true">M</div>
                                            <div class="item-info">
                                                <div class="item-name">Mega Bass Bundle</div>
                                                <div class="small-muted">Bass cabinet + amplifier</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="small-muted">#VDK-3312-09</td>
                                    <td>
                                        <div class="period">
                                            <div class="date-start">Aug 05, 2023</div>
                                            <div class="date-end">to Aug 07, 2023</div>
                                        </div>
                                    </td>
                                ...
                                <!-- Row 4 - Refunded (NO review button) -->
                                <tr>
                                    <td>
                                        <div class="item-cell">
                                            <div class="item-img" aria-hidden="true">H</div>
                                            <div class="item-info">
                                                <div class="item-name">Home Studio Setup</div>
                                                <div class="small-muted">Mic + stand + cables</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="small-muted">#VDK-2101</td>
                                    <td>
                                        <div class="period">
                                            <div class="date-start">Jul 12, 2023</div>
                                            <div class="date-end">to Jul 14, 2023</div>
                                        </div>
                                    </td>
                                    <td class="amount-cell"><strong>₱89.00</strong></td>
                                    <td><span class="status-pill status-refunded">Refunded</span></td>
                                    <td>
                                        <div class="actions-cell">
                                            <a class="action-btn action-download" href="#" download aria-label="Download receipt" title="Download receipt">
                                                <svg width="14" height="14" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <div class="pagination">
                            <div class="pagination-info">Showing 1 to 4 of 24 results</div>
    ...
    <script src="client/bookinghistory/bookinghistory.js"></script>
</body>
</html>
