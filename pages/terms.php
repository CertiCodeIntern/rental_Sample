...
<head>
    ...
    <meta name="description" content="RentIt Terms of Service - Rules and guidelines for using our platform.">
    <title>Terms of Service - RentIt</title>
    ...
    <header class="site-header">
        <div class="container header-inner">
            ...
            <nav class="main-nav">
                ...
                <a href="pages/aboutus.php" class="nav-link">About</a>
        ...
        <nav class="mobile-nav" id="mobileNav">
            ...
            <a href="pages/aboutus.php" class="mobile-link">About</a>
    ...
    <main>
        ...
        <section class="page-header">
            <div class="container">
                ...
                <p class="page-subtitle">Last updated: February 1, 2026</p>
            </div>
        </section>
                ...
                <div class="legal-content">
                    ...
                    <div class="legal-body">
                        <section id="acceptance">
                            ...
                            <p>By accessing or using RentIt's videoke rental management platform ("Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you may not access or use the Service.</p>
                            <p>We reserve the right to modify these Terms at any time. Your continued use of the Service after any changes constitutes acceptance of the new Terms.</p>
                        </section>

                        <section id="description">
                            <h2>2. Description of Service</h2>
                            <p>RentIt provides a cloud-based platform for managing videoke rental businesses, including but not limited to:</p>
                            <ul>
                        ...
                        <section id="accounts">
                            ...
                            <p>You must be at least 18 years old and capable of forming a binding contract to use the Service. By using the Service, you represent that you meet these requirements.</p>
                        </section>
                        ...
                        <section id="payment">
                            ...
                            <p>The Service offers various subscription plans. By selecting a plan, you agree to pay the applicable fees as described at the time of purchase.</p>
                            ...
                            <h3>Free Trial</h3>
                            <p>We may offer a free trial period. You will be notified before being charged at the end of any trial period.</p>
                        </section>

                        <section id="intellectual-property">
                            <h2>6. Intellectual Property</h2>
                            <h3>Our Rights</h3>
                            <p>The Service, including its original content, features, and functionality, is owned by RentIt and is protected by copyright, trademark, and other intellectual property laws.</p>

                            <h3>Your Content</h3>
                            <p>You retain ownership of any content you submit to the Service. By submitting content, you grant us a license to use, modify, and display that content in connection with the Service.</p>

                            <h3>Feedback</h3>
                            <p>Any feedback, suggestions, or ideas you provide about the Service may be used by us without any obligation to you.</p>
                        </section>
                        ...
                        <section id="termination">
                            ...
                            <p>Upon termination, your right to use the Service will immediately cease. You may terminate your account at any time by contacting us.</p>
                        </section>
                        ...
                        <section id="limitation">
                            ...
                            <p>TO THE MAXIMUM EXTENT PERMITTED BY LAW, RENTIT SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO:</p>
                            <ul>
                        ...
                        <section id="governing-law">
                            ...
                            <p>Any disputes arising from these Terms shall be resolved through binding arbitration in Manila, Philippines.</p>
                        </section>
