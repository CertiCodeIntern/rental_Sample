...
<head>
    ...
    <meta name="description" content="Contact RentIt - Get in touch with our support team.">
    ...
    <!-- Stylesheets (Order: Theme → Layout → Pages) -->
                ...
                <div class="contact-grid">
                    ...
                    <div class="contact-info">
                        ...
                        <div class="info-card">
                            ...
                            <a href="pages/wip.php" class="btn-outline">Start Chat</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="faq-grid">
                    <div class="faq-item">
                        ...
                        <p>Simply create a free account and you can start managing your rentals right away. No credit card required.</p>
                    </div>
                    <div class="faq-item">
                        <h4>Is there a free trial?</h4>
                        <p>Yes! We offer a 14-day free trial with full access to all features. No commitment required.</p>
                    </div>
                    <div class="faq-item">
                        <h4>What payment methods do you accept?</h4>
                        <p>We accept all major credit cards, GCash, Maya, and bank transfers.</p>
                    </div>
                    <div class="faq-item">
